...
from mod_ca_ji_tian import HanJiTian, han_ji_ca_piau_im  # 新的查字典模組
...
class CellProcessor:
    ...
    def _process_han_ji(
        ...
        ji_tian = self.ji_tian
        result = ji_tian.han_ji_ca_piau_im(
            han_ji=han_ji,
        ...
        for idx, entry in enumerate(result):
            # 轉換音標
            tlpa_im_piau = entry.get('台語音標', '')
            tai_gi_im_piau, han_ji_piau_im = self._convert_piau_im(tlpa_im_piau)
