...
class ExcelCell:
    ...
    def in_iong_jin_kang_piau_im_ji_khoo(
        ...
        # tai_gi_im_piau_bak = self.jin_kang_piau_im_ji_khoo_dict.get_tai_gi_im_piau_by_han_ji(han_ji=han_ji)
        entry = self.jin_kang_piau_im_ji_khoo_dict.get_entry_by_han_ji_and_coordinate(
            han_ji=han_ji,
            coordinate=(row, col)
        )
        tai_gi_im_piau = entry['tai_gi_im_piau'] if entry else ""
    ...
    def _process_jin_kang_piau_im(self, han_ji: str, jin_kang_piau_im: str, cell, row: int, col: int):
        ...
        if  jin_kang_piau_im == '=':    # 引用既有的人工標音
            ...
            # 若在【人工標音字庫】工作表找到對應的【台語音標】和【漢字標音】，表能成功引用
        ...
        # print(f"漢字儲存格：{xw.utils.col_name(han_ji_col)}{han_ji_row}（{han_ji_row}, {han_ji_col}）==> {msg}")
