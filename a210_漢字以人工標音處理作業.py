...
class CellProcessor(ExcelCell):
    ...
    def _resolve_manual_annotation(
        self, cell, han_ji: str, jin_kang_val: any
    ) -> str | None:
        """
    ...
    def _process_jin_kang_piau_im(self, cell):
        ...
        # 解析人工標音 (處理 =, # 邏輯)
        manual_tai_gi_im = self._resolve_manual_annotation(
            cell, han_ji, jin_kang_piau_im
        )
