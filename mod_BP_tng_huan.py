...
def get_bp_phing_im_kian_from_tiau(tiau_ho):
    """
    由【調號】取得【按鍵】

    Args:
        tiau_ho: 閩拚音標調號（如 "1", "2", "3", "5", "7", "8", "0"）
    ...
    if tiau_ho in BP_PHING_IM_HO_TIAU_MAP:
        # 依【調號】取得【聲調】，再依【聲調】取得【按鍵】
        tiau_mia = BP_PHING_IM_HO_TIAU_MAP[tiau_ho]
        return BP_PHING_IM_TIAU_KIAN_MAP[tiau_mia]
